...
namespace ice {
    namespace ast {
        ...
        class type : public node {
            public:
                type(const string_list& name, const type_list& specializations, int pointer=0);
                virtual ~type();

                node_type get_node_type() const { return NODE_TYPE_TYPE; }
        ...
        class param : public node {
            public:
                ...
                node_type get_node_type() const { return NODE_TYPE_PARAM; }
        ...
        class func_decl : public decl {
            public:
                ...
                node_type get_node_type() const { return NODE_TYPE_FUNC_DECL; }

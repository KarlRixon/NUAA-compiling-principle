...
%type <string_list> qualified_name qualified_name_tail package_decl opt_package_decl
%type <mod> module

%%

module: opt_package_decl opt_use_list module_decl_list {
      ice::ast::string_list package = $1;
      if (package.empty()) package.push_back("main");
      $$ = new ice::ast::module(package, $2, $3);
...
package_decl: TOK_PACKAGE qualified_name TOK_SEMICOLON { $$ = $2; }
            ;
...
use: TOK_USE qualified_name use_tail { $$ = ice::ast::import_list::value_type($2, $3.empty() ? "" : $3); }
   ;
...
type: opt_asterisks qualified_name type_tail { $$ = new ice::ast::type($2, $3, $1); }
    ;

qualified_name: TOK_IDENT qualified_name_tail { $$ = $2; $$.push_front($1); }
              ;

qualified_name_tail: TOK_PERIOD TOK_IDENT qualified_name_tail { $$ = $3; $$.push_front($2); }
                   | /* nil */ { $$; }
                   ;

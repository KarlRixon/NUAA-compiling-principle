...
class array : public object {
    public:
        ...
        const T& first() const { return _values.front(); };
        const T& last() const { return _values.back(); }
        ...
        void unshift(const T& value) { _values.push_front(value); }
        T shift() { T value = _values.front(); _values.pop_front(); return value; }

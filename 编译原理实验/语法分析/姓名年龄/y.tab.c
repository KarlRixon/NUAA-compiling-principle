...
{
  "$end", "error", "$undefined", "NUMBER", "STRING", "EXIT", "$accept",
  "statement", "name_age", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 24 "name_age.y" /* yacc.c:1646  */
    {printf("%d people in all\n", (yyvsp[0].ival));exit(0);}
#line 1213 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 28 "name_age.y" /* yacc.c:1646  */
...
#line 31 "name_age.y" /* yacc.c:1906  */

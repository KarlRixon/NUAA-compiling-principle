...
{
  "$end", "error", "$undefined", "HEXADECIMAL", "DECIMAL", "$accept",
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 19 "transf.y" /* yacc.c:1646  */
    {printf("%d = 0x%x\n", (yyvsp[0].val), (yyvsp[0].val));}
#line 1209 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 20 "transf.y" /* yacc.c:1646  */
    {printf("0x%x = %d\n", (yyvsp[0].val), (yyvsp[0].val));}
